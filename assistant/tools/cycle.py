...
PROMPT_ADDON = """\
МОДУЛЬ ЦИКЛА включён. интерпретируй энергию по фазам ТОЛЬКО если человек сам назвал день цикла:
...
если в утреннем чекине назвали день цикла — сохрани через log_cycle_day и мягко подскажи,
чего ждать по энергии. НЕ выдумывай день цикла и не настаивай на теме.
"""
